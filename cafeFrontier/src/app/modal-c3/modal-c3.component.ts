...
@Component({
  selector: 'app-modal-c3',
  templateUrl: './modal-c3.component.html',
  styleUrls: ['./modal-c3.component.css']
})
export class ModalC3Component implements OnInit {
  clickCount: number = 0;
  clickLimit: number = 4;
  pie:any;
  ...
  valorPantalla(cantidadChicas: number, pago: string) {
    this.valorChic = 80000 / cantidadChicas
    ...
    dat.servicio = { id: 1 };
    dat.fecha_dia = this.fechaf1;
    dat.comisiones = 120000;
    dat.total_ganado = "120000";
