...
@Component({
  selector: 'app-modal-c2',
  templateUrl: './modal-c2.component.html',
  styleUrls: ['./modal-c2.component.css']
})
export class ModalC2Component implements OnInit {
  clickCount: number = 0;
  clickLimit: number = 3;
  pie:any;
  ...
  valorPantalla(cantidadChicas: number, pago: string) {
    this.valorChic = 60000 / cantidadChicas
    ...
    dat.comisiones = 100000;
    dat.total_ganado = "100000";
