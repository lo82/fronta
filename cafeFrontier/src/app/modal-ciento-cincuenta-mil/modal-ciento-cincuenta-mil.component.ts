...
@Component({
  selector: 'app-modal-ciento-cincuenta-mil',
  templateUrl: './modal-ciento-cincuenta-mil.component.html',
  styleUrls: ['./modal-ciento-cincuenta-mil.component.css']
})
export class ModalCientoCincuentaMilComponent implements OnInit {
  ...
  crearBotellaJhonny() {
   ...
   data.tragos = { id: this.j};
    ...
    data.total_ganado = 150000 * this.jhonny;
    data.usuario ={id:4}
    ...
    this.acciones.postCrearAccioness(data).subscribe(res => console.log(res),
      ...
      Swal.fire(`Botella Jhonny Waker Double Black ${data.total_ganado}`, 'a pendiente correctamente');
